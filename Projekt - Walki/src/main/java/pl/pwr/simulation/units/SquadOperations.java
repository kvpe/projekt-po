...
public class SquadOperations
 {
         ...
         Event deathFromStarvation = squad -> {
             ...
             for(; i <= 0; i++){
                 ...
                 if(squad.getSquadQuantity() == 0){
                     ...
                     System.out.println(squad.getName() + " have starved to death.");
                     squad.removeSquad();
                     break;
                 }
             }
     ...
     public int attackArchers(Squad squad){
        if(squad.getArchersDamage() != 0) System.out.println(squad.getName() + "'s archers have shot at a different squad!");
